(function (stylecow) {
	...
	stylecow.Code = function (css, options) {
		...
		this.sourceMapDest = options.sourceMapDest;

		if (this.sourceMapDest && this.sourceMapDest !== 'embed') {
			this.sourceMapRoot = path.dirname(this.sourceMapDest);
		} else {
		...
		if (options.sourceMap) {
			...
			if (this.sourceMapDest === 'embed') {
				this.code += '\n/*# sourceMappingURL=data:application/json;base64,' + (new Buffer(this.mapString)).toString('base64') + ' */\n';
			} else if (this.sourceMapDest) {
				this.code += '\n/*# sourceMappingURL=' + path.relative(path.dirname(this.file), this.sourceMapDest) + ' */\n';
			}
		}
	}
	...
	stylecow.Code.prototype = {
		save: function () {
			...
			if (this.sourceMapDest && this.sourceMapDest !== 'embed') {
				save(this.sourceMapDest, this.mapString);
			}
		},
